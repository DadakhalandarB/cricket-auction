...
<div class="row">
	<div class="column">
		...
		<input type="text" name="id" value="13" class="text"><br>
	...
	<div class="column">
		<div class="card">
			...
			<p>CREDITS:83</p>
			<form action="exx.php" method="POST">
		<input type="text" name="id" value="14"class="text"><br>
		<input type="submit" name="search" value="Details" >
	</form>
	</div>
	</div>
	...
	<div class="column">
		<div class="card">
			...
			<p>CREDITS:89</p>
			<form action="exx.php" method="POST">
		<input type="text" name="id" value="15"class="text"><br>
		<input type="submit" name="search" value="Details" >
	</form>
	</div>
	</div>
	...
	<div class="column">
		<div class="card">
			...
			<p>CREDITS:79</p>
			<form action="exx.php" method="POST">
		<input type="text" name="id" value="16"class="text"><br>
		<input type="submit" name="search" value="Details" >
	</form>
	</div>
	</div>
	...
	<div class="column">
		<div class="card">
			...
			<p>CREDITS:83</p>
			<form action="exx.php" method="POST">
		<input type="text" name="id" value="17"class="text"><br>
		<input type="submit" name="search" value="Details" >
	</form>
	</div>
	</div>
	...
	<div class="column">
		<div class="card">
			...
			<p>CREDITS:81</p>
			<form action="exx.php" method="POST">
		<input type="text" name="id" value="18"class="text"><br>
		<input type="submit" name="search" value="Details" >
	</form>
	</div>
	</div>
		...
		<div class="card">
			...
			<p>CREDITS:85</p>
			<form action="exx.php" method="POST">
		<input type="text" name="id" value="19"class="text"><br>
		<input type="submit" name="search" value="Details" >
	</form>
	</div>
	</div>
		...
		<div class="card">
			...
			<p>CREDITS:87</p>
			<form action="exx.php" method="POST">
		<input type="text" name="id" value="20"class="text"><br>
		<input type="submit" name="search" value="Details" >
	</form>
	</div>
	</div>
		...
		<div class="card">
			...
			<p>CREDITS:82</p>
			<form action="exx.php" method="POST">
		<input type="text" name="id" value="21"class="text"><br>
		<input type="submit" name="search" value="Details" >
	</form>
	</div>
	</div>
		...
		<div class="card">
			...
			<p>CREDITS:78</p>
			<form action="exx.php" method="POST">
		<input type="text" name="id" value="22"class="text"><br>
		<input type="submit" name="search" value="Details" >
	</form>
	</div>
	</div>
		...
		<div class="card">
			...
			<p>CREDITS:82</p>
			<form action="exx.php" method="POST">
		<input type="text" name="id" value="23"class="text"><br>
		<input type="submit" name="search" value="Details" >
	</form>
	</div>
	</div>
	...
	<div class="column">
		<div class="card">
			...
			<p>CREDITS:80</p>
			<form action="exx.php" method="POST">
		<input type="text" name="id" value="24"class="text"><br>
		<input type="submit" name="search" value="Details" >
	</form>
	</div>
	</div>
	...
	<div class="column">
		<div class="card">
			...
			<p>CREDITS:89</p>
			<form action="exx.php" method="POST">
		<input type="text" name="id" value="25"class="text"><br>
		<input type="submit" name="search" value="Details" >
	</form>
	</div>
	</div>
		...
		<div class="card">
			...
			<p>CREDITS:85</p>
			<form action="exx.php" method="POST">
		<input type="text" name="id" value="26"class="text"><br>
		<input type="submit" name="search" value="Details" >
	</form>
	</div>
	</div>
		...
		<div class="card">
			...
			<p>CREDITS:68</p>
			<form action="exx.php" method="POST">
		<input type="text" name="id" value="27"class="text"><br>
		<input type="submit" name="search" value="Details" >
	</form>
	</div>
	</div>
		...
		<div class="card">
			...
			<p>CREDITS:80</p>
			<form action="exx.php" method="POST">
		<input type="text" name="id" value="28"class="text"><br>
		<input type="submit" name="search" value="Details" >
	</form>
	</div>
	</div>
		...
		<div class="card">
			...
			<p>CREDITS:88</p>
			<form action="exx.php" method="POST">
		<input type="text" name="id" value="29"class="text"><br>
		<input type="submit" name="search" value="Details" >
	</form>
	</div>
	</div>
		...
		<div class="card">
			...
			<p>CREDITS:84</p>
			<form action="exx.php" method="POST">
		<input type="text" name="id" value="30"class="text"><br>
		<input type="submit" name="search" value="Details" >
	</form>
	</div>
	</div>
		...
		<div class="card">
			...
			<p>CREDITS:79</p>
			<form action="exx.php" method="POST">
		<input type="text" name="id" value="31"class="text"><br>
		<input type="submit" name="search" value="Details" >
	</form>
	</div>
	</div>
		...
		<div class="card">
			...
			<p>CREDITS:83</p>
			<form action="exx.php" method="POST">
		<input type="text" name="id" value="32"class="text"><br>
		<input type="submit" name="search" value="Details" >
	</form>
	</div>
	</div>
		...
		<div class="card">
			...
			<p>CREDITS:88</p>
			<form action="exx.php" method="POST">
		<input type="text" name="id" value="33"class="text"><br>
		<input type="submit" name="search" value="Details" >
	</form>
	</div>
	</div>
		...
		<div class="card">
			...
			<p>CREDITS:77</p>
			<form action="exx.php" method="POST">
		<input type="text" name="id" value="34"class="text"><br>
		<input type="submit" name="search" value="Details" >
	</form>
	</div>
	</div>
		...
		<div class="card">
			...
			<p>CREDITS:79</p>
			<form action="exx.php" method="POST">
		<input type="text" name="id" value="35"class="text"><br>
		<input type="submit" name="search" value="Details" >
	</form>
	</div>
	</div>
		...
		<div class="card">
			...
			<p>CREDITS:75</p>
			<form action="exx.php" method="POST">
		<input type="text" name="id" value="36"class="text"><br>
		<input type="submit" name="search" value="Details" >
	</form>
	</div>
	</div>
		...
		<div class="card">
			...
			<p>CREDITS:68</p>
			<form action="exx.php" method="POST">
		<input type="text" name="id" value="37"class="text"><br>
		<input type="submit" name="search" value="Details" >
	</form>
	</div>
	</div>
		...
		$sql=mysqli_query("CREATE PROCEDURE user() SELECT * FROM 'players' WHERE '$role'='batsman'");
